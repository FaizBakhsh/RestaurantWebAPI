...
import org.example.entity.PaymentWiseSale;
...
@CrossOrigin(origins = "*")
@RestController
@RequestMapping("/api/PaymentWiseSale")
public class PaymentWiseRptController {

    public PaymentWiseRptController() {
    }
    ...
    public ResponseEntity<byte[]> generateReport(@RequestBody Map<String, Object> request, @PathVariable("period") String period) {
        try {
            ...
            List<PaymentWiseSale> sales = mapper.convertValue(request.get("ReportData"), new TypeReference<List<PaymentWiseSale>>() {
            });
            ...
            CompanyInfo companyProfile = request.containsKey("CompanyProfile")
                    ...
                    : null;
            File file;
            file = ResourceUtils.getFile("classpath:PaymentWiseSaleRpt.jrxml");
