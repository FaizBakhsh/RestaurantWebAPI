...
@NgModule({
  ...
  declarations: [ManageRoleComponent, ManagePermissionsComponent, ManageUserComponent, CreateUserDialogComponent, AssignRoleToUserComponent, CreateUserRoleComponent],
  providers: [
    DatePipe,
    // { provide: HTTP_INTERCEPTORS, useClass: httpInterceptor, multi: true },
    //{ provide: HTTP_INTERCEPTORS, useClass: ErrorInterceptor, multi: true },
    AuthorizationCheck, SecurityService, TokenCheck]
})
