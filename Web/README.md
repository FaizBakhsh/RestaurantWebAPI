...
```bash
# dev server with hot reload at http://localhost:4400
$ npm start
```

Navigate to [http://localhost:4400](http://localhost:4400). The app will automatically reload if you change any of the source files.
