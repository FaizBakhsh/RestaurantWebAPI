...
namespace Restaurant.Core.Entities
{
    public class ItemDE : BaseDomain
    {
        ...
        public List<RecipeDE>? ItemRecipes { get; set; }
        public List<SizeDE> ProductAttribs { get; set; }
        public List<RuntimeModifierDE>? Modifiers { get; set; }
        public List<int>? KDSIds { get; set; }
        ...
        public ItemDE()
        {
            ...
            EndDate=null;
            StartDate=null;
            this.ProductAttribs = new List<SizeDE>();
        }
        #endregion
    }
}
