    ...
    public class ClientsDAL
    {
        ...
        public bool ManageClients(ClientsDE _clients, MySqlCommand? cmd)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue ("logoBase64Path", _clients.LogoBase64Path);
        ...
        public List<ClientsDE> SearchClients(string WhereClause, MySqlCommand cmd)
        {
            ...
            try
            {
                ...
                clients = cmd.Connection.Query<ClientsDE>("call Restaurant.SearchClients('" + WhereClause + "')").ToList();
                return clients;
            }
            catch (Exception)
            {
